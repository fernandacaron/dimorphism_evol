...
pam3.1 <- lets.subsetPAM(pam, pam$Species_name[1001:1168], remove.cells = T)
pam3.2 <- lets.subsetPAM(pam, pam$Species_name[1169:1210], remove.cells = T)
pam3.3 <- lets.subsetPAM(pam, pam$Species_name[1211:1216], remove.cells = T)
pam3.4 <- lets.subsetPAM(pam, pam$Species_name[1217:1221], remove.cells = T)
pam3.5 <- lets.subsetPAM(pam, pam$Species_name[1222:1231], remove.cells = T)
pam3.6 <- lets.subsetPAM(pam, pam$Species_name[1232:1252], remove.cells = T)
pam3.7 <- lets.subsetPAM(pam, pam$Species_name[1253:1336], remove.cells = T)
pam3.8 <- lets.subsetPAM(pam, pam$Species_name[1337:1500], remove.cells = T)
pam4 <- lets.subsetPAM(pam, pam$Species_name[1501:2000], remove.cells = T)
pam5 <- lets.subsetPAM(pam, pam$Species_name[2001:2500], remove.cells = T)
pam6 <- lets.subsetPAM(pam, pam$Species_name[2501:3000], remove.cells = T)
...
mid3.4 <- lets.midpoint(pam3.4, method = "CMD")
mid3.5 <- lets.midpoint(pam3.5, method = "CMD")
mid3.6 <- lets.midpoint(pam3.6, method = "CMD")
mid3.7 <- lets.midpoint(pam3.6, method = "CMD")
mid3.8 <- lets.midpoint(pam3.6, method = "CMD")
mid4 <- lets.midpoint(pam4, method = "CMD")
mid5 <- lets.midpoint(pam5, method = "CMD")
mid6 <- lets.midpoint(pam6, method = "CMD")
