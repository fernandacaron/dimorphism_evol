...
#save(fitMK_col, file = "data/aves/fitMK_col.RData")

fitMK_psi <- lapply(tr, fitMK, sdi = sdi, data = dat, taxon = "Psittaciformes")
#save(fitMK_psi, file = "data/aves/fitMK_psi.RData")

fitMK_ans <- lapply(tr, fitMK, sdi = sdi, data = dat, taxon = "Anseriformes")
#save(fitMK_ans, file = "data/aves/fitMK_ans.RData")

fitMK_acc <- lapply(tr, fitMK, sdi = sdi, data = dat, taxon = "Accipitriformes")
#save(fitMK_acc, file = "data/aves/fitMK_acc.RData")

fitMK_gal <- lapply(tr, fitMK, sdi = sdi, data = dat, taxon = "Galliformes")
#save(fitMK_gal, file = "data/aves/fitMK_gal.RData")

fitMK_pic <- lapply(tr, fitMK, sdi = sdi, data = dat, taxon = "Piciformes")
#save(fitMK_pic, file = "data/aves/fitMK_pic.RData")

fitMK_apo <- lapply(tr, fitMK, sdi = sdi, data = dat, taxon = "Apodiformes")
#save(fitMK_apo, file = "data/aves/fitMK_apo.RData")

fitMK_cha <- lapply(tr, fitMK, sdi = sdi, data = dat, taxon = "Charadriiformes")
#save(fitMK_cha, file = "data/aves/fitMK_cha.RData")

fitMK_pas <- lapply(tr, fitMK, sdi = sdi, data = dat, taxon = "Passeriformes")
#save(fitMK_pas, file = "data/aves/fitMK_pas.RData")

#load(file = "data/aves/fitMK_col.RData")
#load(file = "data/aves/fitMK_psi.RData")
#load(file = "data/aves/fitMK_ans.RData")
#load(file = "data/aves/fitMK_acc.RData")
#load(file = "data/aves/fitMK_gal.RData")
#load(file = "data/aves/fitMK_pic.RData")
#load(file = "data/aves/fitMK_apo.RData")
#load(file = "data/aves/fitMK_cha.RData")
#load(file = "data/aves/fitMK_pas.RData")
...
write.csv(aicw_res, "tables/Table2_unformatted.csv")
...
plot_ans <- plot(fitMK_ans[[1]]$fitSYM, show.zeros = FALSE, spacer = 0.2, 
                 mar = rep(0.5,4), cex.rates = 1.2)
invisible(mapply(draw.circle, plot_ans$x, plot_ans$y, col = cols3, border = NA,
                 MoreArgs = list(radius = 0.13)))
